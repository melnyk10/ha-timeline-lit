 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: bt, defineProperty: vt, getOwnPropertyDescriptor: At, getOwnPropertyNames: St, getOwnPropertySymbols: Et, getPrototypeOf: wt } = Object, y = globalThis, et = y.trustedTypes, Pt = et ? et.emptyScript : "", q = y.reactiveElementPolyfillSupport, T = (r, t) => r, I = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? Pt : null;
      break;
  ...
  return e;
} }, Z = (r, t) => !bt(r, t), st = { attribute: !0, type: String, converter: I, reflect: !1, useDefault: !1, hasChanged: Z };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const M = globalThis, j = M.trustedTypes, it = j ? j.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, ut = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, $t = "?" + _, xt = `<${$t}>`, E = document, R = () => E.createComment(""), H = (r) => r === null || typeof r != "object" && typeof r != "function", G = Array.isArray, Ct = (r) => G(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", W = `[ 	
\f\r]`, U = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, rt = /-->/g, ot = />/g, v = RegExp(`>|${W}(?:([^\\s"'>=/]+)(${W}*=${W}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), nt = /'/g, at = /"/g, ft = /^(?:script|style|textarea|title)$/i, Ot = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), m = Ot(1), C = Symbol.for("lit-noChange"), c = Symbol.for("lit-nothing"), lt = /* @__PURE__ */ new WeakMap(), A = E.createTreeWalker(E, 129);
function _t(r, t) {
...
const Ut = (r, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const a = r[l];
    let d, p, h = -1, $ = 0;
    for (; $ < a.length && (n.lastIndex = $, p = n.exec(a), p !== null); ) $ = n.lastIndex, n === U ? p[1] === "!--" ? n = rt : p[1] !== void 0 ? n = ot : p[2] !== void 0 ? (ft.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = v) : p[3] !== void 0 && (n = v) : n === v ? p[0] === ">" ? (n = i ?? U, h = -1) : p[1] === void 0 ? h = -2 : (h = n.lastIndex - p[2].length, d = p[1], n = p[3] === void 0 ? v : p[3] === '"' ? at : nt) : n === at || n === nt ? n = v : n === rt || n === ot ? n = U : (n = v, i = void 0);
    const f = n === v && r[l + 1].startsWith("/>") ? " " : "";
    o += n === U ? a + xt : h >= 0 ? (s.push(d), a.slice(0, h) + ut + a.slice(h) + _ + f) : a + _ + (h === -2 ? l : f);
  }
  return [_t(r, o + (r[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), s];
};
class N {
    ...
    for (; (i = A.nextNode()) !== null && a.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const h of i.getAttributeNames()) if (h.endsWith(ut)) {
          const $ = p[n++], f = i.getAttribute(h).split(_), k = /([.?@])?(.*)/.exec($);
          a.push({ type: 1, index: o, name: k[2], strings: f, ctor: k[1] === "." ? Mt : k[1] === "?" ? Rt : k[1] === "@" ? Ht : B }), i.removeAttribute(h);
...
class Tt {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (n === a.index) {
        let d;
        a.type === 2 ? d = new z(o, o.nextSibling, this, t) : a.type === 1 ? d = new a.ctor(o, a.name, a.strings, this, t) : a.type === 6 && (d = new Nt(o, this, t)), this._$AV.push(d), a = s[++l];
      }
...
class z {
  ...
  _$AI(t, e = this) {
    t = O(this, t, e), H(t) ? t === c || t == null || t === "" ? (this._$AH !== c && this._$AR(), this._$AH = c) : t !== this._$AH && t !== C && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ct(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class B {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let n = !1;
    if (o === void 0) t = O(this, t, e, 0), n = !H(t) || t !== this._$AH && t !== C, n && (this._$AH = t);
    else {
      const l = t;
      let a, d;
      for (t = o[0], a = 0; a < o.length - 1; a++) d = O(this, l[s + a], e, a), d === C && (d = this._$AH[a]), n || (n = !H(d) || d !== this._$AH[a]), d === c ? t = c : t !== c && (t += (d ?? "") + o[a + 1]), this._$AH[a] = d;
    }
    n && !i && this.j(t);
  }
  j(t) {
...
F == null || F(N, z), (M.litHtmlVersions ?? (M.litHtmlVersions = [])).push("3.3.1");
const zt = (r, t, e) => {
...
var ct;
x._$litElement$ = !0, x.finalized = !0, (ct = S.litElementHydrateSupport) == null || ct.call(S, { LitElement: x });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Dt = { attribute: !0, type: String, converter: I, reflect: !1, hasChanged: Z }, kt = (r = Dt, t, e) => {
...
var jt = Object.defineProperty, Bt = Object.getOwnPropertyDescriptor, b = (r, t, e, s) => {
  ...
  render() {
    return m`
      <ha-card .header=${this._title ?? "Outage timeline"}>
        ${this._loading ? m`
              <div class="status loading">Loading outages…</div>` : c}

        ${this._error ? m`
              <div class="status error">Error: ${this._error}</div>` : c}
